        ...
        public static void CreateProducts(AppDbContext database)
        {
            if (!database.Products.Any())
            {
                ...
                database.Products.Add(new Product
                {
                    ...
                    Price = 129,
                    Category = "Belysning",
                    ImagePath = "dynamo_flashlight.jpg"
                });
                ...
                database.Products.Add(new Product
                {
                    ...
                    ImagePath = "hand_crank_radio.jpg"
                });
                ...
                database.Products.Add(new Product
                {
                    ...
                    ImagePath = "emergency_whistle.jpg"
                });
                ...
                database.Products.Add(new Product
                {
                    ...
                    Price = 59,
                    Category = "Hygien",
                    ImagePath = "insect_repellent.jpg"
                });
                ...
                database.Products.Add(new Product
                {
                    ...
                    ImagePath = "emergency_blanket.jpg"
                });
                ...
                database.Products.Add(new Product
                {
                    ...
                    ImagePath = "multi_function_bag.jpg"
                });
